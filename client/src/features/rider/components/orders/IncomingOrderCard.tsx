...
const IncomingOrderCard = memo(({ orderId, onAccept, onExpire }: IncomingOrderCardProps) => {
  ...
  return (
    <div className="slide-up-enter bg-white rounded-2xl border-2 border-primary shadow-(--shadow-lg) overflow-hidden" role="alert" aria-live="polite">
      ...
      <div className="p-4 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <button
            ...
            className="flex items-center gap-1.5 bg-primary text-white text-sm font-bold px-4 py-2.5 rounded-xl hover:bg-red-700 disabled:opacity-60 disabled:cursor-not-allowed transition active:scale-95 min-w-11 min-h-11 justify-center"
          >
