...
import { MapSkeleton } from "@/features/rider/components/skeletons/RiderSkeletons";
...
const RiderMap = memo(({ order }: RiderMapProps) => {
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 shadow-(--shadow-md) p-3">
