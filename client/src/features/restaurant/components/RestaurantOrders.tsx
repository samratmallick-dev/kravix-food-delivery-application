...
import { fetchRestaurantOrders } from "@/services/api/order.services";
import { ShoppingBag, VolumeX } from "lucide-react";
import OrderCard from "./RestaurantOrderCard";
      ...
      return (
            <div className="pt-10 container-app space-y-6">
                  ...
                  <h2 className="text-2xl font-bold mb-6 text-gray-500">
                        Total Orders <span className="text-sm font-normal text-gray-400">({orders.length})</span>
                  </h2>
