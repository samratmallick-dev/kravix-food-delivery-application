...
export const menuBaseUrl = import.meta.env.VITE_API_URL_MENU || (isDev ? "http://localhost:9000/api/v1/menu-items" : "https://kravix-restaurant.onrender.com/api/v1/menu-items");
...
export const addressBaseUrl = import.meta.env.VITE_API_URL_ADDRESS || (isDev ? "http://localhost:9000/api/v1/addresses" : "https://kravix-restaurant.onrender.com/api/v1/addresses");
...
export const paymentBaseUrl = import.meta.env.VITE_API_URL_PAYMENT || (isDev ? "http://localhost:8888/api/v1/payments" : "https://kravix-utilities.onrender.com/api/v1/payments");
...
export const cloudinaryBaseUrl = import.meta.env.VITE_API_URL_CLOUDINARY || (isDev ? "http://localhost:8888/api/v1/uploads" : "https://kravix-utilities.onrender.com/api/v1/uploads");
