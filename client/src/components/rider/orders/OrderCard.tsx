...
const OrderCard = memo(({ order }: OrderCardProps) => {
  ...
  return (
    <div
      ...
      className="bg-white rounded-2xl border border-gray-100 shadow-[var(--shadow-sm)] p-4 space-y-3 cursor-pointer hover:shadow-[var(--shadow-md)] transition-shadow active:scale-[0.99]"
      role="button"
      tabIndex={0}
