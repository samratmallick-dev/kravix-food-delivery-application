...
const OrderFilters = memo(({ activeTab, onTabChange, search, onSearchChange, sort, onSortChange }: OrderFiltersProps) => {
  ...
  return (
    <div className="space-y-3 sticky top-0 z-10 bg-background pb-2 pt-1">
      {/* Search */}
      <div className="flex items-center gap-2 bg-white border border-gray-200 rounded-xl px-3 py-2.5 focus-within:border-primary transition-colors shadow-[var(--shadow-sm)]">
      ...
      {/* Sort */}
      {showSort && (
        <div className="flex gap-2 bg-white rounded-xl p-2 border border-gray-100 shadow-[var(--shadow-sm)]">
