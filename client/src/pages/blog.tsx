                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                              {posts.map((post, idx) => {
                                    ...
                                    return (
                                          <article
                                                key={idx}
                                                className="bg-white rounded-2xl overflow-hidden border border-gray-100 hover:border-primary/20 hover:shadow-lg transition-all duration-300 hover:translate-y-[-4px] flex flex-col h-full group"
                                          >
                                                <div className={`h-48 w-full bg-gradient-to-br ${post.gradient} flex items-center justify-center relative shrink-0`}>
