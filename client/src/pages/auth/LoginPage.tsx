...
import { loginWithEmail, loginWithGoogle, resendVerificationEmail } from "@/services/api/auth.services";
  ...
  return (
    <div className="w-full max-w-md">
      ...
      <div className="max-w-md w-full space-y-6">
        ...
        <p className="text-center text-sm text-gray-500 font-semibold">Sign in to continue</p>
        ...
        <form onSubmit={handleEmailLogin} className="space-y-4">
          ...
          {error && (
            <div id="login-error" role="alert" className="text-sm text-red-600 space-y-1">
              <p>{error}</p>
