...
import { getAllUsers, blockUser, getAllRiders, verifyRider } from "@/services/api/admin.services";
...
const AdminUsers = () => {
      ...
      return (
            <div className="p-6 space-y-5">
                  ...
                  <AdminTable columns={columns} data={users} loading={loading} page={page} pages={pages} total={total} onPageChange={setPage} keyExtractor={(u: any) => u._id} />
