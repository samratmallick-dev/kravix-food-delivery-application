...
import { getAllOrders, cancelOrder } from "@/services/api/admin.services";
...
const AdminOrders = () => {
      ...
      return (
            <div className="p-6 space-y-5">
                  ...
                  <AdminTable columns={columns} data={orders} loading={loading} page={page} pages={pages} total={total} onPageChange={setPage} keyExtractor={(o: any) => o._id} />
