import { riderBaseUrl } from "@/constants";
import { request } from "@/services/apiClient";
import type { ApiResponse, SuccessResponse, IRider } from "@/types";
import { compressImageToFile, uploadImage } from "@/utils";
...
export const addRiderProfile = async (payload: AddRiderProfilePayload): Promise<ApiResponse<IRider>> => {
      const compressed = await compressImageToFile(payload.image);
