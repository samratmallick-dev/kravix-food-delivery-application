export const openApiSpec = {
  ...
  paths: {
    ...
    "/ai/chat": { post: { tags: ["AI"], summary: "Chat with Kravix AI", security: [{ bearerAuth: [] }], responses: { "200": { description: "AI response" } } } },
    "/ai/feedback": { post: { tags: ["AI"], summary: "Submit AI feedback", security: [{ bearerAuth: [] }], responses: { "204": { description: "Feedback recorded" } } } }
  }
};
